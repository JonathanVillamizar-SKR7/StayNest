        ...
        <body>
            <nav>
                <div class="logo">
                    <a href="${pageContext.request.contextPath}/home.jsp">
                        <img src="${pageContext.request.contextPath}/img/Logo_right.png" alt="StayNest" class="logo">
                    </a>
                </div>
                <div class="menu">
                    <a href="${pageContext.request.contextPath}/index.jsp" class="Index m-lg-4">STAYS</a>
                    <a href="${pageContext.request.contextPath}/login.jsp">
                        <img src="${pageContext.request.contextPath}/img/user.png" alt="User Icon"
                            class="User-Icon m-4">
                    </a>
                </div>
            </nav>
            ...
            <header>
                <div class="image-container">
                    <img src="${pageContext.request.contextPath}/img/portada_home.jpg" alt="PortadaHome"
                        class="portada-image">
                    <div class="logo-overlay">
                        <img src="${pageContext.request.contextPath}/img/Logo_right_white.png" alt="StayNest Logo"
                            class="logoPortada">
                    </div>
                </div>
            </header>
            ...
            <main>
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card my-3">
                                <img class="card-img-top img-fluid" src="${pageContext.request.contextPath}/img/7-1.jpg"
                                    alt="Card image">
                                <div class="card-body">
                        ...
                        <div class="col-lg-4">
                            <div class="card my-3">
                                <img class="card-img-top img-fluid" src="${pageContext.request.contextPath}/img/6-1.jpg"
                                    alt="Card image">
                                <div class="card-body">
                        ...
                        <div class="col-lg-4">
                            <div class="card my-3">
                                <img class="card-img-top img-fluid" src="${pageContext.request.contextPath}/img/1-1.jpg"
                                    alt="Card image">
                                <div class="card-body">
                ...
                <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
                    <div class="col mb-3">
                        <a href="${pageContext.request.contextPath}/home.jsp"
                            ...
                            <img src="${pageContext.request.contextPath}/img/logo_white.png" width="60%" alt="">
                        </a>
                    </div>
                    <div class="col mb-3">
                    </div>
