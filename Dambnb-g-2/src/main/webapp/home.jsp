	...
	<main>
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="card my-3">
						<img class="card-img-top img-fluid" src="img/7-1.jpg"
							alt="Card image">
						<div class="card-body">
				...
				<div class="col-lg-4">
					<div class="card my-3">
						<img class="card-img-top img-fluid" src="img/6-1.jpg"
							alt="Card image">
						<div class="card-body">
				...
				<div class="col-lg-4">
					<div class="card my-3">
						<img class="card-img-top img-fluid" src="img/1-1.jpg"
							alt="Card image">
						<div class="card-body">
		...
		<div class="container my-5">
			<div class="row align-items-center">
				<div class="col-md-6 d-flex flex-column justify-content-around"
					...
					<button class="btn btn-warning btn-lg mt-3 custom-button">Find
						your Nest</button>
				</div>
